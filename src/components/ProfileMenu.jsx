  ...
  return (
    <div className="profile-menu" ref={ref}>
      ...
      <style>{`
        ...
        .profile-avatar { min-height: 44px; min-width: 44px; width: 32px; height: 32px; border-radius: 50%; background: var(--avatar-bg); border: 1px solid var(--border); color: var(--accent); display: flex; align-items: center; justify-content: center; cursor: pointer; box-shadow: 0 0 0 1px var(--accent-soft); transition: box-shadow 180ms ease, border-color 180ms ease; }
        ...
        .profile-row { display: flex; align-items: center; gap: 10px; width: 100%; background: transparent; border: none; color: var(--text); font-size: 12px; padding: 9px 8px; border-radius: var(--r-sm); cursor: pointer; text-align: left; }
        ...
        .profile-admin-badge { display: flex; align-items: center; gap: 3px; flex-shrink: 0; font-size: 12px; font-weight: 600; letter-spacing: 0.04em; color: var(--accent); background: var(--accent-soft); border: 1px solid var(--accent); border-radius: var(--r-pill); padding: 2px 6px; }
