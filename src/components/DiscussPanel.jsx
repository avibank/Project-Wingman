  ...
  return (
    <div className="discuss">
      ...
      <style>{`
        ...
        .leaderboard { max-width: 640px; margin: 0 auto 12px; width: 100%; font-size: 12px; color: var(--muted); background: var(--panel-alt); border: 1px solid var(--border); border-radius: var(--r-md); padding: 8px 12px; flex-shrink: 0; }
        ...
        .discuss-empty { display: flex; flex-direction: column; align-items: center; gap: 8px; text-align: center; color: var(--muted); font-size: 12px; padding: 30px 0; }
        ...
        .discuss-avatar { width: 32px; height: 32px; border-radius: 50%; color: #fff; display: flex; align-items: center; justify-content: center; font-family: var(--font-display); font-size: 14px; flex-shrink: 0; box-shadow: inset 0 0 0 1px rgba(255,255,255,0.12); }
        ...
        .discuss-meta { display: flex; gap: 6px; align-items: baseline; font-size: 12px; color: var(--text); margin-bottom: 3px; }
        .discuss-realname { color: var(--muted2); font-weight: 500; font-size: 12px; }
        .discuss-item p { margin: 0; font-size: 14px; color: var(--text-soft); line-height: 1.5; }
        .discuss-edit { display: flex; gap: 6px; align-items: center; }
        .discuss-edit input { flex: 1; background: var(--panel-alt); border: 1px solid var(--accent); border-radius: var(--r-sm); padding: 6px 10px; font-size: 14px; color: var(--text); }
        ...
        .discuss-reactions button { display: flex; align-items: center; gap: 4px; background: transparent; border: 1px solid var(--border); color: var(--muted2); font-size: 12px; padding: 3px 8px; border-radius: var(--r-pill); cursor: pointer; }
        ...
        .discuss-upload-error { font-size: 12px; color: var(--bad); margin-bottom: 6px; text-align: center; }
        ...
        .discuss-input { display: flex; align-items: center; gap: 8px; width: 100%; background: var(--well); border: 1px solid var(--border); box-shadow: var(--shadow-inset); border-radius: 32px; padding: 8px; min-height: 58px; transition: border-color 0.2s ease, box-shadow 0.2s ease; }
        .discuss-input:focus-within { border-color: var(--accent-soft); box-shadow: 0 0 8px 1px var(--accent-soft); }
                .discuss-input input[type="text"], .discuss-input input:not([type]) { flex: 1; background: transparent; border: none; padding: 10px 14px; color: var(--text); font-size: 14px; }
        ...
        .discuss-signin { flex-shrink: 0; display: flex; align-items: center; justify-content: center; gap: 8px; max-width: 640px; margin: 8px auto 0; width: 100%; background: var(--panel-alt); border: 1px dashed var(--border); color: var(--accent); font-size: 12px; padding: 14px; border-radius: var(--r-lg); cursor: pointer; }
