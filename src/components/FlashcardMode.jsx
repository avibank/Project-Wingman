  ...
  return (
    <div className="flashcards">
      ...
      <style>{`
        ...
        .flashcards-exit { display: flex; align-items: center; gap: 4px; background: transparent; border: none; color: var(--accent); font-size: 13px; cursor: pointer; padding: 0; }
        ...
        .flashcard-hint { font-family: 'JetBrains Mono', monospace; font-size: 10.5px; letter-spacing: 0.08em; color: var(--accent); text-transform: uppercase; }
        ...
        .flashcard-option { font-size: 12px; color: var(--muted); padding: 6px 10px; border-radius: 8px; border: 1px solid var(--border); }
        .flashcard-option.is-correct { color: var(--good); border-color: var(--good); background: rgba(76,175,125,0.08); }
        .flashcard-tap { display: flex; align-items: center; gap: 5px; font-size: 11px; color: var(--muted2); margin-top: 6px; }
