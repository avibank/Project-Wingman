  ...
  return (
    <div className="flashcards">
      ...
      <style>{`
        ...
        .flashcards-exit { display: flex; align-items: center; gap: 4px; background: transparent; border: none; color: var(--accent); font-size: 12px; cursor: pointer; padding: 0; }
        .flashcards-count { font-family: var(--font-mono); font-size: 12px; color: var(--muted); }
        ...
        .flashcard-hint { font-family: var(--font-ui); font-size: 12px; color: var(--accent); }
        .flashcard-front p { font-family: var(--font-display); font-size: 17px; color: var(--text); line-height: 1.4; margin: 0; }
        .flashcard-answer { display: flex; align-items: center; gap: 6px; font-family: var(--font-display); font-size: 16px; color: var(--good); margin: 0; }
        .flashcard-options { display: flex; flex-direction: column; gap: 5px; width: 100%; text-align: left; margin-top: 4px; }
        .flashcard-option { font-size: 12px; color: var(--muted); padding: 6px 10px; border-radius: var(--r-sm); border: 1px solid var(--border); }
        .flashcard-option.is-correct { color: var(--good); border-color: var(--good); background: rgba(76,175,125,0.08); }
                .flashcard-tap { display: flex; align-items: center; gap: 5px; font-size: 12px; color: var(--muted); margin-top: 6px; }
        .flashcards-nav { display: flex; gap: 12px; }
        .flashcards-nav button { width: 40px; height: 40px; border-radius: 50%; background: var(--elev-1); border: 1px solid var(--border); box-shadow: var(--shadow-1); color: var(--text); display: flex; align-items: center; justify-content: center; cursor: pointer; }
