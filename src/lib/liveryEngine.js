...
export const LIVERIES = [
  ...
  { id: "amber", name: "Amber", anchors: "bronze → amber → caution yellow",
    description: "Master caution. Nothing is actually wrong. Probably.",
  ...
  { id: "tarmac", name: "Tarmac grey", anchors: "gunmetal → graphite → grey",
    description: "Concrete and a copper floodlight. Everything you can see is borrowed.",
  ...
  { id: "runway", name: "Runway green", anchors: "olive → grass → spring green",
    description: "Grass past the threshold. Knows its place, stays in it.",
  ...
  { id: "skydrol", name: "Skydrol violet", anchors: "indigo → violet → lavender",
    description: "Hydraulic purple. If you've had it on your hands, you know.",
