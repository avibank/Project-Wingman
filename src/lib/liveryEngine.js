...
export const LIVERIES = [
  { id: "sky", name: "Sky", anchors: "navy → lapiz → sky blue",
    description: "Above the weather, where nothing is anyone's problem yet.",
    hue: 266, dDark: -11, dLight: -31, midAt: 0.42, midC: 1.35,
    chroma: 0.100, ground: 0.140, light: 0.950, fillAbs: 84, fillC: 0.22 },
  { id: "amber", name: "Master Caution", anchors: "bronze → amber → caution yellow",
  ...
  { id: "tarmac", name: "Tarmac", anchors: "gunmetal → graphite → grey",
    description: "Floodlit concrete at three in the morning. Everything you can see is borrowed.",
  ...
  { id: "beacon", name: "Beacon", anchors: "maroon → university red → signal red",
    description: "Night vision. Deep, close, and slightly up to something.",
  ...
  { id: "runway", name: "Threshold", anchors: "olive → grass → spring green",
    description: "Past the numbers, where the ground gives you permission.",
    hue: 142, dDark: -14, dLight: 9, midAt: 0.46, midC: 1.16,
    chroma: 0.095, ground: 0.120, light: 0.905, fillAbs: 118, fillC: 0.16 },
  { id: "skydrol", name: "Skydrol", anchors: "indigo → violet → lavender",
