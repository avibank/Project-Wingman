...
const GUTTER = `
<style>
  /* 1180 = the app's own .content cap (1100px including its 22px of padding)
     plus this gutter, so the two content boxes are the same number at every
     width: 1056 at 1280, 644 at 768, 314 at 390. The licence page is
     unaffected -- its .col caps at 680 well inside both. */
  .wrap{max-width:1180px;padding-inline:62px}
